...
import static quantitymeasurement.QuantityMeasurementException.ExceptionType.*;
...
public class QuantityMeasurementTest {
    ...
    public void given1Metre_whenConvertedToKilometre_shouldReturnConvertedResults() {
        double convertedValue = quantityMeasurement.convert(1.0,Unit.METRE,Unit.KILOMETRE);
        assertEquals(0.001,convertedValue,0.0);
    }

    @Test
    public void given1Inch_whenConvertedToYard_shouldReturnConvertedResults() {
        double convertedValue = quantityMeasurement.convert(1.0,Unit.INCH,Unit.YARD);
    ...
    public void given1Litre_whenConvertedToYard_shouldThrowException() {
        try {
            quantityMeasurement.convert(1.0, Unit.LITRE, Unit.YARD);
        } catch (QuantityMeasurementException e) {
            assertEquals(INVALID_CONVERSION, e.type);
        }
    }

    @Test
    public void given1Litre_whenConvertedToGallon_shouldReturnConvertedResults() {
        double convertedValue = quantityMeasurement.convert(1.0,Unit.LITRE,Unit.GALLON);
    ...
    public void given1Fahrenheit_whenConvertedToCelcius_shouldReturnConvertedResults() {
        double convertedValue = quantityMeasurement.convert(1.0,Unit.FAHRENHEIT,Unit.CELCIUS);
